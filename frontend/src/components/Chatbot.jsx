...
export default function Chatbot() {
  ...
  const handleSend = async (e) => {
    ...
    try {
      // Slice(1) to remove the initial "Hi there!" model greeting which crashes Gemini 
      // since Gemini conversations MUST start with a 'user' role.
  ...
  // A very basic renderer to bold markdown (**text**) safely without extra libraries
